...
const Highlight = props => (
  <SyntaxHighlighter language="javascript" style={solarizedDark} {...props} />
);
      ...
      <div className="Wrapper">
        <header>
          ...
          <p className="Description">
            A React component wrapper around{' '}
            <a href="//inorganik.github.io/countUp.js/">CountUp.js</a>. This
            component counts up a number in an animated way.
          </p>
        ...
        <section>
          <h2>Installation</h2>
          <Highlight>npm install react-countup --save</Highlight>
        </section>
